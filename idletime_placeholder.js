$(function() {
    var idleTimeInMinutes = 30; // Testing: 10 seconds (.167); Production: 10 minutes
    
    $.idleTimer((idleTimeInMinutes * 60) * 1000); // Convert minutes to seconds to milliseconds

    $(document).on( "idle.idleTimer", (event, elem, obj) => {
        var modalElement = document.getElementById('restartModal');
